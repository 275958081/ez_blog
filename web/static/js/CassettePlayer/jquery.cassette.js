...
( function( window, $, undefined ) {
	...
	$.Song.prototype 		= {
		...
		_init				: function() {
			...
			this.sources	= {
				mp3	: '/static/music/CassettePlayer/songs/' + this.name + '.mp3',
				ogg	: '/static/music/CassettePlayer/songs/' + this.name + '.ogg'
			};
	...
	$.Sound.prototype		= {
		...
		getSource			: function( type ) {
			...
			return '/static/music/CassettePlayer/sounds/' + this.action + '.' + type;
